  ...
  return (
    <div className='about'>
        <div className="about-left">
            <img src="/students.jpg" alt="" className='about-img' />
        ...
        <div className="about-right">
            ...
            <p>Embark on a transformative educational journey with our
                ...
                skills, and experiences neede to excel in the dynamic field of
                education.
            </p>
            <p>
                With a focus on innovation, hands-on learning, and personalized
                mentorship, our programs prepare aspiring educators to make a 
                meaningful impact in classrooms, schools, and communiities.
            </p>
            <p>
